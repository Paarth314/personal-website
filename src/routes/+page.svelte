...
<div class="m-8 md:mx-16 md:my-10">
    ...
    <div class="font-body sm:text-lg">
        ...
        <br />
        <br />
        My main research interests lie in Generative ML and Computer Vision / Image related applications.
        I am also generally interested in ML and it's potential applications in the real world.
    </div>
</div>
...
<div class="m-8 md:mx-16 md:my-10">
    ...
    <div class="font-body sm:text-lg">
        ...
        <a href="cv-paarth.pdf" target="_blank" class="text-xl font-medium underline">Download</a>
    </div>
</div>
...
<div class="m-8 md:mx-16 md:my-10">
    ...
    <div class="font-body sm:text-lg">
        ...
        <span class="font-medium"
            ...
            >ac<span class="text-zinc-300">_DOT_</span>in</span
        >
        <br />
        Github :
        <a href="https://github.com/PaarthIyer" target="_blank" class="font-medium underline"
            >github.com/PaarthIyer</a
        >
        <!-- 
        <br /><br /> LinkedIn :<br />
        <a href="/" target="_blank" class="font-medium underline">Download</a> -->
    </div>
</div>
...
<div class="m-8 md:mx-16 md:my-10">
    ...
    <div class="font-body sm:text-lg">
        ...
        >.
        <a
            href="https://cssbattle.dev/player/pibits"
            target="_blank"
            class="font-medium text-primary-700 underline">Here</a
        >
        is a link to my profile
    </div>
    <br /><br /><br /><br /><br />
    <span class="italic">More stuff will be added to the website soon.</span>
    <br /><br /><br />
</div>
